...
const Body = () => {
  ...
  const fetchData=async ()=>{
   ...
   const data=await fetch("https://www.swiggy.com/dapi/restaurants/list/v5?lat=17.418945&lng=78.4432214&is-seo-homepage-enabled=true&page_type=DESKTOP_WEB_LISTING");
